 ...
 * {@link #onFailure(int, org.apache.http.Header[], byte[], Throwable)}, {@link #onStart()},
 * {@link #onFinish()}, {@link #onRetry(int)} and {@link #onProgress(int, int)} methods as required.
 * <p>
 * &nbsp;
 * </p>
 * For example:
...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface
{
    ...
    /**
     * Creates a new AsyncHttpResponseHandler with a user-supplied looper. If the passed looper is
     * null, the looper attached to the current thread will be used.
     *
     * @param looper
    ...
    {
        sendMessage(obtainMessage(SUCCESS_MESSAGE, new Object[] { statusCode, headers,
                responseBytes }));
    }
    ...
    final public void sendFailureMessage(int statusCode, Header[] headers, byte[] responseBody,
            Throwable throwable)
    {
        sendMessage(obtainMessage(FAILURE_MESSAGE, new Object[] { statusCode, headers,
