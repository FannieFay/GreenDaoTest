...
public class BookContent extends FragmentActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ViewPageFragmentAdapter mAdapter = new ViewPageFragmentAdapter(getSupportFragmentManager(),
                mListFragment);
    ...
    private void initList()
    {
        ...
        arrayList.add("        言如诗接着说道:“小妹听闻陈兄师出名门,师伯就是天穹上人,所以想请代为引荐。让小女子能入得仙派,即便做一名杂役也好过在风尘中沦落。");
        arrayList
        ...
        arrayList.add("        言如诗盈盈一笑,站起对陈云生飘飘万福,口中言谢。又说了一会,女子起身道别,望着她离去的背影,陈云生心头升起一种异样的感觉");
        arrayList
        ...
        mList = bookPageFactory.getArrayList(stringBuffer.toString());
    }
}
